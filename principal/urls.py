...
urlpatterns = patterns('',
  ...
  # url(r'^gestionusuarios/registrar/$', 'principal.views.registrarusuario', name='registrar_usuario'),
  ...
  url(r'^gestionproyectos/eliminar_proyecto/(\d+)$', 'principal.views.eliminar_proyecto',name='eliminar_proyecto'),
  ...
  url(r'^media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': settings.MEDIA_ROOT}),# url(r'^home/$' ,'buscador.views.indexarArchivos', name='indexar'),
)
